                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="header">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="title">今日订单管理</h4>
                                    </div>
                                </div>
                                <div class="row">
                                    <form method="get" action="" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'" class="form-horizontal">
                                
	                                    <div class="col-md-2"> 
	                                        <input class="form-control" name="taskParam" type="text" placeholder="请输入订单编号"  ></input>    
	                                    </div>
	                                    <div class="col-md-2"> 
	                                        <input class="form-control" name="ladingBillParam" type="text" placeholder="请输入对象名称"  ></input>              
	                                    </div>                                 
	                                    <div class="col-md-2"> 
	                                        <input class="form-control" name="date1Param" type="date" placeholder="装卸开始时间"  ></input>               
	                                    </div>
	                                    <div class="col-md-2"> 
	                                        <input class="form-control" name="date2Param" type="date" placeholder="装卸结束时间"  ></input>               
	                                    </div>
	                                    <div class="col-md-4"> 
                                ...
                                <div class="row">
	                                <div class="col-md-3" >
	                                    <a class="btn btn-primary btn-fill" href="#">添加订单信息</a>
                            		</div>
                                    
                            		<div class="col-md-3" >
	                                    <a class="btn btn-danger btn-fill" href="#">批量删除订单信息</a>
                            		</div>
                                </div>
                                    ...
                                    <td><h5>更新</h5></td>
                                  	...
                                  	<tbody>
										<tr>
	                                        ...
	                                        <td>A56d89</td>
	                                        <td>2018-4-1 20:02:34</td>
	                                        <td>￥5666</td>
	                                        <td>未知对象</td>
	                                        <td><a href="#"><span class="label label-info">查看具体详情</span></a></td>
	                                        <td><a href="#"><span class="label label-danger">删除</span></a></td>
	                                        <td><a href="#"><span class="label label-success">驳回</span></a></td>
		                                </tr>
		                                
		                                <tr>
											<td><input type="checkbox"></input></td>
	                                        <td>A56d90</td>
	                                        <td>2018-4-1 20:05:52</td>
	                                        <td>￥6666</td>
	                                        <td>未知对象</td>
	                                        <td><a href="#"><span class="label label-info">查看具体详情</span></a></td>
	                                        <td><a href="#"><span class="label label-danger">删除</span></a></td>
